...
//         res.json({ username: user.username, apartment: user.apartment });
//     } catch (err) {
//         res.status(500).json({ message: 'Something went wrong', error: err.message });
//     }
// });
...
// // Remove the verifyToken middleware from admin routes
...
// // Serve the admin dashboard HTML page without checking for admin status
...
//     id: 'apartment123', // Replace with actual apartment ID or data
//     address: '123 Main St',
//     price: 1200,
//     features: ['2 Bedrooms', '1 Bathroom', 'Pool']
// };
...
// //         // Include apartment details in the response
// //         res.json({ username: user.username, apartment: user.apartment });
// //     } catch (err) {
// //         res.status(500).json({ message: 'Something went wrong', error: err.message });
// //     }
...
// app.put('/api/payment/:id/status', verifyToken, async (req, res) => {
